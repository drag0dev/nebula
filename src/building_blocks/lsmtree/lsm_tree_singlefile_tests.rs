use crate::building_blocks::SSTableBuilderSingleFile;
...
use std::ops::Range;
use std::path::Path;
use crate::building_blocks::sstable::SF;
...
fn insert_range(
    ...
    let mut builder = SSTableBuilderSingleFile::new(dir, &path, 100, 0.1, 10)
